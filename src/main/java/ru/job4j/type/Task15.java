 ...
 * Примечание: в строке кода return a + ", " + b + ", " + c; высчитанные Вами 3 числа собираются в строку (String),
 * и эта строка является возвращаемым значением нашего метода в виде перечисления чисел через запятую.
 * Важно! Решить упражнение нужно только c помощью арифметических операций,
